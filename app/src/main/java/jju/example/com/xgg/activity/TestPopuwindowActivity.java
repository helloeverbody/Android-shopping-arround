...
public class TestPopuwindowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_popuwindow);
    ...
    private View getView() {
        View view = LayoutInflater.from(TestPopuwindowActivity.this).inflate(
