 ...
 */
public class ClassifyPageFragment1 extends BaseFragment {

    private int shopClassifyId = 1;                  //店铺分类id
    private static final String TAG = "分类页面1";
    ...
    public ClassifyPageFragment1() {
        // Required empty public constructor
    }
    @SuppressLint("ValidFragment")
    public ClassifyPageFragment1(String msg) {
        this.msg = msg;
        // Required empty public constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        shopClassifyId = getArguments().getInt("classifyId",1);
        initView(view);
        initBanner();
        loadProductData();
    ...
    public void loadProductData(){
        String condition = " and shop_id=prod_shop_id and shop_clas_id = "+shopClassifyId+" ORDER BY shop_id";        //查询条件
