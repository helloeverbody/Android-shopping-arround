...
public class RegistActivity extends FullTranStatActivity implements View.OnClickListener {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.arg1) {
                ...
                case 3:
                    ...
                    errorDialog = new LoginErrorDialog(RegistActivity.this,R.style.LoginErrorDialog);
                    errorDialog.setMsg(messgaeObject.get("detail").getAsString());
                    errorDialog.show();
    ...
    */
    ...
    private void checkAccount(){
        String cust_account = etPhone.getText().toString().replace(" ", "");
        Log.i(TAG, "checkAccount: "+cust_account);
        Log.i(TAG, "checkAccount: "+isMobilePhone(cust_account));
        if(!isMobilePhone(cust_account)){
            errorDialog = new LoginErrorDialog(RegistActivity.this,R.style.LoginErrorDialog);
            errorDialog.setMsg("手机号格式有误");
            errorDialog.show();
            return;
        }
        RequestParams params=new RequestParams();     //封装参数

        String condition = " and cust_account="+cust_account;
        ...
        httpClient.post(Constant.CUSTOMER_FIND, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if(statusCode==200){        //响应成功
                    ...
                    if(basePojo.isSuccess()){
                        errorDialog = new LoginErrorDialog(RegistActivity.this,R.style.LoginErrorDialog);
                        errorDialog.setMsg("该账号已注册！");
                        errorDialog.show();
                        errorDialog.autoDismiss();
                    }else{
                        changeBtnGetCode();
