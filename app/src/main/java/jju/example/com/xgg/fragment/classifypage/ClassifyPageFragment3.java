 ...
 */
public class ClassifyPageFragment3 extends BaseFragment {

    private static final String TAG = "分类页面3";
    private String msg;
    ...
    public ClassifyPageFragment3() {
        // Required empty public constructor
    }
    @SuppressLint("ValidFragment")
    public ClassifyPageFragment3(String msg) {
        this.msg = msg;
        // Required empty public constructor
    }
...
*/
    ...
    public void loadProductData(){
        String condition = " and shop_id=prod_shop_id and shop_clas_id = 3 ORDER BY shop_id";        //查询条件
