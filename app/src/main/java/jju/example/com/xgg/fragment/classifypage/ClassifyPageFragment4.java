 ...
 */
public class ClassifyPageFragment4 extends BaseFragment {

    private static final String TAG = "分类页面4";
    private String msg;
    ...
    public ClassifyPageFragment4() {
        // Required empty public constructor
    }
    @SuppressLint("ValidFragment")
    public ClassifyPageFragment4(String msg) {
        this.msg = msg;
        // Required empty public constructor
    }
...
*/
    ...
    public void loadProductData(){
        String condition = " and shop_id=prod_shop_id and shop_clas_id = 4 ORDER BY shop_id";        //查询条件
